...
class TestStatusItem(BaseModel):
    ...
    project_name: str = Field("", description="專案名稱")
    new_project_name: str = Field("", description="完整專案名稱")
    product_category: str = Field("", description="產品類別")
    customer: str = Field("", description="客戶")
    flash: str = Field("", description="Flash 類型")
    controller: str = Field("", description="控制器")
    sub_version: str = Field("", description="子版本")
